...
def stage_bgt_pand(
    production_db: DatabaseResource, gdal: GDALResource, extract_bgt
) -> Output[PostgresTableIdentifier]:
    """The BGT Pand layer, loaded as-is from the extract."""
    create_schema(production_db, SCHEMA_STAGE, logger=logger)
    ...
    drop_table(production_db, new_table, logger=logger)
