from dagster import build_op_context, get_dagster_logger
...
def test_get_extract_metadata(test_data_dir):
    ...
    metadata = bagextract_metadata(logger, test_data_dir / "lvbag-extract")
...
def test_load_bag_layer(database, file_store, gdal, test_data_dir):
    ...
    drop_table(database, test_bag_table, logger)
