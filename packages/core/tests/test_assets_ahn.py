...
def test_metadata_table_ahn3(resources_ahn):
    metadata = metadata_table_ahn3(resources_ahn["computation_db"])
    tbl = PostgresTableIdentifier("ahn", "metadata_ahn3")
    assert table_exists(resources_ahn["computation_db"], tbl)
...
def test_metadata_table_ahn4(resources_ahn):
    metadata = metadata_table_ahn4(resources_ahn["computation_db"])
...
def test_metadata_table_ahn5(resources_ahn):
    metadata = metadata_table_ahn5(resources_ahn["computation_db"])
