...
def test_download_extra(context):
    _ = download_extract(
        ...
        featuretypes=context.op_execution_context.op_execution_context.op_config["featuretypes"],
        data_format="gml",
        geofilter=context.op_execution_context.op_execution_context.op_config.get("geofilter"),
