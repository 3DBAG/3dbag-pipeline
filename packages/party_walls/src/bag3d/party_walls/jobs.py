...
job_nl_party_walls = define_asset_job(
    ...
    """,
    selection=AssetSelection.keys(["party_walls", "features_file_index"]) |
              AssetSelection.keys(["party_walls", "distribution_tiles_files_index"]) |
              AssetSelection.keys(["party_walls", "party_walls_nl"]) |
              AssetSelection.keys(
