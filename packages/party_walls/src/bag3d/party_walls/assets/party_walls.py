...
def distribution_tiles_files_index(
    ...
    """
    path_quadtree_tsv = file_store.file_store.bag3d_export_dir(
        version=version.version,
    ).joinpath("quadtree.tsv")
    path_tiles_dir = file_store.file_store.bag3d_export_dir(
        version=version.version,
    ).joinpath("tiles")
...
def cityjsonfeatures_with_party_walls_nl(
    ...
    reconstructed_features_dir = file_store_fastssd.file_store.geoflow_crop_dir
