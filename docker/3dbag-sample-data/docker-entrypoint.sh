...
# From: https://github.com/docker-library/postgres/blob/master/14/bullseye/docker-entrypoint.sh
...
_main() {
  ...
  # Run the 3dbag data copy script
  echo 'Copying existing data from /data_container to /data'
  source /docker-entrypoint-initdb.d/docker-entrypoint-copydata.sh
  echo
